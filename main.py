...
YELLOW_SPACHESHIP = pygame.transform.rotate(pygame.transform.scale(
    YELLOW_SPACHESHIP_IMAGE, (SPACESHIP_WIDTH, SPACESHIP_HEIGHT)), 90)

RED_SPACESHIP_IMAGE = pygame.image.load(
    os.path.join('Assets', 'spaceship_red.png'))
RED_SPACHESHIP = pygame.transform.rotate(pygame.transform.scale(
...
def draw_window(red, yellow, red_bullets, yellow_bullets,  red_health, yellow_health):
    ...
    WIN.blit(YELLOW_SPACHESHIP, (yellow.x, yellow.y))
    WIN.blit(RED_SPACHESHIP, (red.x, red.y))
